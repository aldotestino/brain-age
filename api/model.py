...
class Model:
  ...
  def shap_values_waterfall_format(self, formatted_sv, limit):
    ...
    return [*ordered_values[:limit], {'value': remaining_values_sum, 'data': None, 'name': f"{remaining_features_number} other features"}]
